---
title: "Chapter 10 Problem Set Solutions (using R 3.5 RNG)"
...
We can also use the prune function to trim down the full tree to a specified CP level. Thus, if we set the CP=0.022 (slightly larger than that of the minimum error tree), then it does the pruning for us.
```{r 10.3d}
pruned_tree <- prune(full_tree, cp = 0.022)
